# -*- coding: utf-8 -*-
"""
Created on Tue Jul 26 12:25:38 2022
...
class selfharm_prediction():
     def __init__(self,path='/content/drive/MyDrive/CLEF_eRISK_2022/',model='tfidf', model_path='saved_models/entropy_svm/', model_source='allenai/longformer-base-4096',vec_len=20,clf_opt='s',no_of_selected_features=None, output_file='output.json'):
        self.path = path
        self.model = model
...
# BERT model    
     def bert_training_model(self,trn_data,trn_cat,test_size=0.2,max_length=512): 
        ...
        trainer = Trainer(
            ...
            compute_metrics=self.compute_metrics(train_dataset),     # the callback that computes metrics of interest
            )
        print('\n Trainer done \n')
        trainer.train()
        print('\n Trainer train done \n')        
